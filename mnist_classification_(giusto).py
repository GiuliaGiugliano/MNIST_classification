# -*- coding: utf-8 -*-
"""MNIST CLASSIFICATION (GIUSTO).ipynb
...
# Definire il modello RidgeClassifier
...
# Calcolare e stampare la precisione per ogni classe
...
mnist_data_array = mnist.data.values  # Utilizzo di mnist.data.values anziché mnist.data.value
mnist_data_array = mnist_data_array.astype('float32') / 255
...
# Verifica delle dimensioni dei dati di addestramento e test
...
# Trova gli indici delle classi misclassificate
...
# Stampa il report di classificazione che include la precisione per ciascuna classe
print(report)
